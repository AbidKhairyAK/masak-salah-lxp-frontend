...
import PracticeLayout from '@/views/public/practice/_layouts/PracticeLayout.vue'
...
const router = createRouter({
	...
	routes: [
		...
		{ path: '/course/:courseId/practice',	component:  PracticeLayout,	children: practice_routes, meta: { requires_auth: true }}
	]
})
