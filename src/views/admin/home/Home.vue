...
<script setup>
import { ref } from "vue";
import { TableIcon, InboxIcon, ImageIcon, CogIcon } from 'lucide-vue-next'

const value = ref([
    { label: 'Apps', 		color1: '#34d399', color2: '#fbbf24', value: 25, icon: TableIcon },
    { label: 'Messages', 	color1: '#fbbf24', color2: '#60a5fa', value: 15, icon: InboxIcon },
    { label: 'Media', 		color1: '#60a5fa', color2: '#c084fc', value: 20, icon: ImageIcon },
    { label: 'System', 		color1: '#c084fc', color2: '#c084fc', value: 10, icon: CogIcon }
]);
</script>